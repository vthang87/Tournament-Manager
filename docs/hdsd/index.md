...
1. [Chuẩn bị giải](chuan-bi-giai.md): tạo nội dung, luật, vòng đấu và danh sách đăng ký.
2. [Import dữ liệu](import-export.md) hoặc nhập thủ công.
3. [Bốc thăm](boc-tham.md), sinh trận và xếp lịch.
4. [Thiết lập sân và PIN](san-va-pin.md).
5. [Điều hành ngày thi đấu](ngay-thi-dau.md).
6. Chia sẻ [trang công khai](khan-gia.md) cho khán giả.
